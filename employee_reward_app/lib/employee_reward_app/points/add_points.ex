defmodule EmployeeRewardApp.AddPoints do
  ...
  schema "add_points" do
    ...
    belongs_to(:receiving_user_id, EmployeeRewardApp.User)
    belongs_to(:giving_user_id, EmployeeRewardApp.User)

    timestamps()
  end

  def changeset(struct, %{"points_given" => points_given, "receiving_user_id" => receiving_user_id, "giving_user_id" => giving_user_id}) do
    cast(struct, points_given, :points_given)
    #|> cast_assoc()
